...
import com.ladinc.showrss.activitys.UpcomingScheduleActivity.getSchedule;
...
public class AiredScheduleActivity extends ListActivity {

	private static final String TAG = "AiredScheduleActivity";
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		try
		{
	        ...
	        setContentView(R.layout.aired_schedule);
	...
	private void configureList()
	{
		...
		ArrayAdapter<String> adapter = new ArrayAdapter<String>(this,
				android.R.layout.simple_list_item_1, android.R.id.text1, schedule.airedAsArray());
